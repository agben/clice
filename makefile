...
all:	\
	ce_clice ce_gen_make ce_scan_asm ce_scan_bash ce_scan_c ce_scan_obj ce_scan_project 
...
install:	\
	...
	$(bindir)/ce_scan_all.sh $(bindir)/ce_scan_asm $(bindir)/ce_scan_bash $(bindir)/ce_scan_c  \
	$(bindir)/ce_scan_obj $(bindir)/ce_scan_project $(bindir)/ce_setup.sh 
...
$(bindir)/ce_scan_all.sh: ce_scan_all.sh
	sudo cp $^ $@
$(bindir)/ce_scan_asm: ce_scan_asm
	sudo cp $^ $@
...
ce_scan_asm: ce_scan_asm.c $(objdir)/ce_args.o $(includedir)/ce_main.h $(objdir)/cef_main.o \
	 $(includedir)/fa_def.h $(includedir)/ut_date.h $(objdir)/libgxtut.a $(includedir)/ut_error.h \
	 $(includedir)/ce_main_def.h $(objdir)/libgxtfa.a $(includedir)/fa_sql_def.h $(includedir)/fa_lun.h
	$(GCC) $(CFLAGS) $^ -o $@ -lsqlite3
ce_scan_bash: ce_scan_bash.c $(objdir)/ce_args.o $(includedir)/ce_main.h $(objdir)/cef_main.o \
	 ...
	 $(includedir)/ce_main_def.h $(objdir)/libgxtfa.a $(includedir)/fa_sql_def.h $(includedir)/fa_lun.h
	$(GCC) $(CFLAGS) $^ -o $@ -lsqlite3
ce_scan_c: ce_scan_c.c $(objdir)/ce_args.o $(includedir)/ce_main.h $(objdir)/ce_parse_name.o \
	 $(objdir)/cef_main.o $(includedir)/fa_def.h $(includedir)/ut_date.h $(objdir)/libgxtut.a \
	 $(includedir)/ut_error.h $(includedir)/ce_main_def.h $(objdir)/libgxtfa.a $(includedir)/fa_sql_def.h \
	 $(includedir)/fa_lun.h
	$(GCC) $(CFLAGS) $^ -o $@ -lsqlite3
ce_scan_obj: ce_scan_obj.c $(objdir)/ce_args.o $(includedir)/ce_main.h $(objdir)/ce_parse_name.o \
	 $(objdir)/cef_main.o $(includedir)/fa_def.h $(includedir)/ut_date.h $(objdir)/libgxtut.a \
	 $(includedir)/ut_error.h $(includedir)/ce_main_def.h $(objdir)/libgxtfa.a $(includedir)/fa_sql_def.h \
	 $(includedir)/fa_lun.h
	$(GCC) $(CFLAGS) $^ -o $@ -lsqlite3
...
$(objdir)/ce_args.o: ce_args.c $(includedir)/ce_main.h
	$(GCC) $(CFLAGS) -c $< -o $@
$(objdir)/ce_parse_name.o: ce_parse_name.c $(includedir)/ce_main.h
	$(GCC) $(CFLAGS) -c $< -o $@
